...
void loop() {
  ...
  // creates buffer with vertically addressed 16x16 bitmap data
  uint8_t thug_life_v [] = {
  ...
  // draws the bitmap above directly into display memory to random position
